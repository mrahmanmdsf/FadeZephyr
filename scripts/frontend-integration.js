 ...
 * This file demonstrates how to integrate Fadezephyr with a web frontend
 */

// For React/Vue/Angular applications
export class FadezephyrClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FadezephyrClient(provider, contractAddress);
